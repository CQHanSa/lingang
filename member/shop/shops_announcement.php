...
$r = $dosql->GetOne("SELECT `content` FROM `#@__shopsnote` WHERE `shopid`='".$r_shop['id']."' and classid='1'");
if(isset($r['content'])){
	$content=$r["content"];
}else{
	$content="";
	...
	<div class="icontent_c">
        ...
        <div class="order_cont1 fr">
            ...
            <div class="order_set2">
                ...
                <input type="hidden" name="action" value="shops_announcement_save" />
				<div style="margin-left:-1px;">
                <textarea name="content" id="content" style="width:963px; height:300px; padding:10px;"><?php echo $content; ?></textarea>
