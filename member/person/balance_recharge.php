...
<div class="icontent">
	<div class="icontent_c">
        ...
        <div class="order_cont1 fr">
            ...
            <div class="order_set">
            	<form name="upmember"  class="upmember" id="form" method="post" action="/data/api/unionpay/unionpay.config.php">
                <input type="hidden" name="userid" value="<?=$r_user['id']?>" />
				<dl>
                	<dt>
                    	<label class="label">充值帐号：</label>
                    	<input type="text" class="class_input"  name="username" id="username" readonly="readonly" value="<?=$r_user['username']?>"/>
                    </dt>
                    <dt>
                    	<label class="label">充值金额：</label>
                    	<input type="text" name="money" class="class_input" value="" datatype="n" nullmsg="请输入充值金额！" errormsg="请输入数字！"  />
                        <span class="Validform_checktip">请输入充值金额</span>
                    </dt>
                </dl>	
                <div class="save_reset"><input type="submit" class="btn1" value="充值" /></div>
                </form>
            </div>
