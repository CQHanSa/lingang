...
<div class="icontent">
	<div class="icontent_c">
        ...
        <div class="w985 fr">
            <div class="balance_top">可用积分：<span><?php echo $r_user['integral']?></span> </div>
            
            <div class="balance_list">
            	<div class="balance_title">积分明细</div>
            	<table class="tb-void" width="100%" cellpadding="0" cellspacing="0">
					<thead>
						<tr bgcolor="#EEE">
                        	<td width="50%" height="40"><span class="pdl10">时间</span></td>
							<td width="20%">操作</td>
							<td width="30%" align="right"><span class="pdr10">积分</span></td>
						</tr>
					</thead>
					<tbody>
                    	<?php
                        $sql = "SELECT * FROM `#@__integral` where userid='".$r_user['id']."' and posttime >= UNIX_TIMESTAMP(DATE_SUB(CURDATE(), INTERVAL 3 MONTH)) order by id desc";
                        ...
                        <tr <?php if($i%2==0) echo 'bgcolor="#F5F5F5"';?>>
                            ...
                            <td align="right"><span class="pdr10"><span class="<?php echo $blance_class?>"><span><?php echo $blance_icon;?></span><?php echo $row['integral']?></span></td>
                        </tr>
                        <?php
						$i++;
						}
