...
<form name="form" id="form" method="post" action="goodsbrand_save.php" onsubmit="return cfm_btype2();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
		<tr>
			...
			<td width="75%"><select name="parentid" id="parentid">
					...
					?>
                    <option value="<?php echo $r_pid['id'];?>" <?php if($row["parentid"]==$r_pid['id']){echo 'selected="selected"';}?>><?php echo $r_pid['classname'];?></option>
                    <?php
					}
					?>
				</select>
