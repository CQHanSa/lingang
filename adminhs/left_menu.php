		...
		<div class="overview"> 
			...
			<div class="menubox">
				...
				<div id="leftmenu01"> 
                    ...
                    <a href="admingroup.php" target="main" title="管理组管理" class="admingroup"></a> 
                </div>
			</div>
			<div class="hr_5"></div>
			<div class="menubox">
				...
				<div id="leftmenu02" style="display:none"> 
                    ...
                    <a href="infosrc.php" target="main" title="信息来源管理" class="infosrc"></a> 
                </div>
			</div>
			<div class="hr_5"></div>
			<div class="menubox">
				...
				<div id="leftmenu03" style="display:none">
                    ...
                    <!--<a href="weblinktype.php" target="main" title="友情链接类别" class="weblinktype"></a>--> 
                </div>
			</div>
			<div class="hr_5"></div>
			<div class="menubox">
				...
				<div id="leftmenu04" style="display:none"> 
                    ...
                    <a href="goodsaddress.php" target="main">商品产地管理</a> 
                    ...
                    <div class="hr_1"> </div>-->
                    <a href="coupon.php" target="main">优惠卷管理</a>
                </div>
			</div>
            <!--
			<div class="hr_5"></div>
...
<div class="copyright"><?php echo date('Y',time());?> © HANSA</div>
</body>
</html>