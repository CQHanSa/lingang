...
<body>
<?php
$row = $dosql->GetOne("SELECT * FROM `#@__goodsaddress` WHERE `id`=$id");
?>
<div class="formHeader"> <span class="title">修改商品产地</span> <a href="javascript:location.reload();" class="reload">刷新</a> </div>
