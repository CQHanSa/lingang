...
function cfm_coupon()
{
	...
	{
		alert("开始领取时间不能大于结束领取时间！");
		$("#endtime").focus();
		return false;
	}
	
	if($("#validity_strat").val() == "")
	{
		alert("请选择开始使用时间！");
		$("#validity_strat").focus();
		return false;
	}
	...
	if($("#validity_strat").val() > $("#validity_end").val())
	{
		alert("开始使用时间不能大于结束使用时间！");
		$("#validity_end").focus();
		return false;
	}
