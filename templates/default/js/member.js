...
function SelectCommunity(val)
{
	...
	$.ajax({
		url : "/ajax.php?a=selectcommunity&value="+val,
		type:'get',
		dataType:'html',
		success:function(data){
...
//商品分类
function SelType(val,level)
{
	
	$("#goodstype_id3").html("<option>--</option>");
	$.ajax({
		url : "/ajax.php?a=gettype&val="+val,
		type:'get',
		dataType:'html',
		success:function(data){
			$("#goodstype_id"+level).html(data);
		}
	});
	
	if(level=='2'){
		$.ajax({
			url : "/ajax.php?a=getbrand&val="+val,
			type:'get',
			dataType:'html',
			success:function(data){
				$("#brandid").html(data);
...
//商品店铺分类
function SelShopType(val,shopid)
{
	$.ajax({
		url : "/ajax.php?a=getshoptype&shopid="+shopid+"&val="+val,
		type:'get',
		dataType:'html',
		success:function(data){
			$("#shoptype_id").html(data);
		}
	});
}